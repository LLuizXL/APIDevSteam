...
namespace APIDevSteam.Migrations
{
    ...
    [Migration("20250513181842_ExclusaoAdminRole")]
    partial class ExclusaoAdminRole
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("APIDevSteam.Models.UsuarioCartao", b =>
                {
                    b.Property<Guid>("usuarioCartaoId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasKey("usuarioCartaoId");

                    b.HasIndex("CartaoId");

                    b.HasIndex("UsuarioId1");

                    b.ToTable("UsuarioCartoes", (string)null);
                });

            modelBuilder.Entity("APIDevSteam.Models.UsuarioJogo", b =>
                {
                    b.Property<Guid>("UsuarioJogoId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("APIDevSteam.Models.UsuarioJogo", b =>
                {
                    ...
                    b.HasOne("APIDevSteam.Models.Game", null)
                        .WithMany("UsuariosCompradores")
            ...
            modelBuilder.Entity("APIDevSteam.Models.Game", b =>
                {
                    b.Navigation("UsuariosCompradores");
                });
